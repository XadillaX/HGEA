...
public:
	...
	inline void					System_SetState(hgeHwndState   state, HGE_HWND    value) { System_SetStateHwnd  (state, value); }
	...
	inline HGE_HWND				System_GetState(hgeHwndState   state) { return System_GetStateHwnd  (state); }
