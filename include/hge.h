...
enum hgeHwndState {
    HGE_HWND_STATE = 15,  // int		window handle: read only
...
class HGE {
   ...
   private:
    ...
    virtual void CALL System_SetStateHwnd(hgeHwndState state, HGE_HWND value) = 0;
    ...
    virtual HGE_HWND CALL System_GetStateHwnd(hgeHwndState state) = 0;
   ...
   public:
    ...
    inline void System_SetState(hgeHwndState state, HGE_HWND value) {
    ...
    inline HGE_HWND System_GetState(hgeHwndState state) {
    ...
    virtual void CALL Gfx_SetTransform(float x = 0, float y = 0, float dx = 0, float dy = 0, float rot = 0,
                                       float hscale = 0, float vscale = 0) = 0;
    ...
    virtual DWORD *CALL Texture_Lock(HTEXTURE tex, bool bReadOnly = true, int left = 0, int top = 0, int width = 0,
                                     int height = 0) = 0;
    virtual void CALL Texture_Unlock(HTEXTURE tex) = 0;
};

extern "C" {
EXPORT HGE *CALL hgeCreate(int ver);
}
